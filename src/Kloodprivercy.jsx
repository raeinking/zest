...
function Kloodprivercy() {
    return (
        <>
            <div className='priversy'>

                <h1>Privacy Policy for Zest Properties</h1>
                ...
                <ul>
                    ...
                    <li><span>Company </span>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Zest Properties LLC, Erbil, Italian Village1, Villa No.90.</li>
                    ...
                    <li><span>Country </span>refers to: Iraq</li>
                    ...
                    <li><span>Website </span>refers to Zest Properties, accessible from www.zest-property.com</li>
                ...
                <ul>
                    ...
                    <li><span> manage Your Account: </span>to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.</li>
                ...
                <ul>
                    <li>By email: info@zest-property.com

                    </li>
                    <li>By visiting this page on our website: https://zest-property.com/khlood

                    </li>
                    <li>By phone number: 7515099771
