...
function Skypark() {
    ...
    const [projectname, setProjectname] = useState('Sky park')
    ...
    return (
        <section>
            <Helmet>
                <title>Experience Tranquil Living in Sky Park Mosul - zest property</title>
                <meta name='description' content="Discover the beauty of Sky park mosul and experience tranquil living at its finest. Our residential development offers a range of living options to suit your lifestyle, including spacious apartments and elegant villas. Surrounded by stunning natural landscapes and picturesque views, as a resident of Sky Park Mosul, you'll enjoy a peaceful retreat from the hustle and bustle of everyday life. Explore our available units and make your dream home a reality today." />
            </Helmet>
                    ...
                    <div className='brochurRight'>
                        <form style={{ width: '100%', maxWidth: '1000px', maxHeight: '1000px', display: 'flex', flexWrap: 'nowrap' }} onSubmit={handleSubmit}>
                            ...
                            <div style={{ display: 'flex', marginTop: 10, marginBottom: 10, alignItems: 'center', width: '100%', justifyContent: 'space-between' }}>
                                ...
                                <a href={"//api.whatsapp.com/send?phone=9647502552006&text=hello iam interested in sky park can you send me details"}>
            ...
            <section className='mainmajidi'>
                ...
                <div className='content'>
                    ...
                    <div className='twothink'>
                        <h3>Sky Park Mosul</h3>
                        <a className='BROCHURE' href=''>See Details</a>
                    </div>
                    <div className="">
                    ...
                    <div className='margin'>
                        ...
                        <div className='overview'>
                            <div className='borderandmargin'>
                                <h5>LOCATION</h5>
                                <h5> Mosul - Al-Asr Branch, Duhok Road, Near Al-Sads Bridge</h5>
                            </div>
                            <div className='borderandmargin'>
                                <h5>PROJECT TYPE</h5>
                                <h5>Residential</h5>
                    ...
                    <div className='dis'>
                        <h3>Description</h3>
                        <p className='pdis'>
Sky Park Mosul is a prestigious real estate development project located in the city of Mosul, Iraq. This project consists of a series of residential buildings that have been constructed quickly and efficiently while maintaining a high level of quality.
                            <br />
                            <br />
                            <br />
Sky Park Mosul is currently one of the most sought-after projects in Mosul, with properties selling at a fast pace. The development offers a range of apartments, providing residents with a modern and comfortable lifestyle in a convenient location.
                            <br />
                            <br />
                            <br />
With its exceptional design and state-of-the-art facilities, Sky Park Mosul is sure to impress anyone looking for a premium property investment in Mosul. Whether you're an investor or a resident, this project is definitely worth considering for its quality, convenience, and value for money.
                        </p>
                        <div>
                        ...
                        <div className='map'>
                            <LoadScript googleMapsApiKey="AIzaSyAoeC-jhvkXaUUCYG8S4KiSzGCxCoiFAO0">
                                <GoogleMap
                                    ...
                                    center={{ lat: 36.451066, lng: 42.983509, position: { lat: 36.451066, lng: 42.983509 } }}
                                    zoom={18}
                                >
                                    <MarkerF position={{ lat: 36.451066, lng: 42.983509 }} />
                                </GoogleMap>
                            </LoadScript>
                        </div>
                    </div>
