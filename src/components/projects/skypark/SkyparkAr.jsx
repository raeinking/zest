...
function SkyparkAr() {
    ...
    const [projectname, setProjectname] = useState('سکاي بارك')
    ...
    return (
        <>
            <Helmet>
                <title>استمتع بالحياة الهادئة في سکاي بارك موصل - عقارات زيست</title>
                <meta name='description' content="اكتشف جمال سکاي بارك موصل واستمتع بالحياة الهادئة في أروع صورها. يقدم مشروعنا السكني مجموعة من الخيارات السكنية لتناسب نمط حياتك، بما في ذلك الشقق الفسيحة والفيلات الأنيقة. محاطًا بمناظر طبيعية ساحرة وإطلالات خلابة، فإنك كساكن في سکاي بارك موصل ستستمتع بتجربة الاسترخاء في بيئة هادئة بعيدًا عن صخب الحياة اليومية. استكشف وحداتنا المتاحة واجعل منزل أحلامك حقيقة اليوم." />
            </Helmet>
            <section>
                        ...
                        <div className='brochurRight arfrom'>
                            <form className='arfrom' style={{ width: '100%', maxWidth: '1000px', maxHeight: '1000px', display: 'flex', flexWrap: 'nowrap' }} onSubmit={handleSubmit}>
                                ...
                                <div style={{ display: 'flex', marginTop: 10, marginBottom: 10, alignItems: 'center', width: '100%', justifyContent: 'space-between' }}>
                                    ...
                                    <a href={"//api.whatsapp.com/send?phone=9647502552006&text=مرحباً ، أنا مهتم بإطلالة سکاي بارك موصل ، هل يمكنك أن ترسل لي التفاصيل؟"}>
                ...
                <div className='imageofheadernorth'><h1>سکاي بارك موصل</h1></div>
                ...
                <section className='mainmajidi'>
                    ...
                    <div className='content'>
                        ...
                        <div className='twothink'>
                            <h3>سکاي بارك موصل</h3>
                            <a className='BROCHURE' href=''>انظر التفاصيل</a>
                        </div>
                        <div className="">
                        ...
                        <div className='margin'>
                            ...
                            <div className='overview'>
                                <div className='borderandmargin'>
                                    <h5>موقع</h5>
                                    <h5>الموصل - الجانب الأيسر ، طريق دهوك ، قرب الجسر السادس</h5>
                                </div>
                                <div className='borderandmargin'>
                                    <h5>نوع المشروع</h5>
                                    <h5>سكني</h5>
                        ...
                        <div className='dis'>
                            <h3>وصف</h3>
                            <p className='pdis'>
سكاي بارك الموصل هو مشروع تطوير عقاري مرموق يقع في مدينة الموصل، العراق. يتكوّن هذا المشروع من مجموعة من المباني السكنية التي تم إنشاؤها بسرعة وكفاءة عالية مع الحفاظ على مستوى عالٍ من الجودة.
                                ...
                                <br />
                                <br />
يُعد سكاي بارك الموصل حالياً من أكثر المشاريع طلباً في الموصل، حيث يتم بيع الوحدات بسرعة كبيرة. ويوفر المشروع مجموعة متنوعة من الشقق السكنية، مما يمنح السكان أسلوب حياة عصري ومريح في موقع مميز.
                                ...
                                <br />
                                <br />
بفضل تصميمه الاستثنائي ومرافقه الحديثة، يُعد سكاي بارك الموصل خياراً مثالياً لكل من يبحث عن استثمار عقاري فاخر في مدينة الموصل. سواء كنت مستثمراً أو ترغب بالسكن، فإن هذا المشروع يستحق النظر لما يقدّمه من جودة وراحة وقيمة مقابل المال.
