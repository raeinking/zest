...
import image1 from './Empire1Pearls.jpg'
import image2 from './Empire2Diamond.jpg'
import image3 from './Empire3BusinessTower.jpg'
...
function Empire() {
    ...
    const [projectname, setProjectname] = useState('empire en')
    ...
    return (
        <section>
            <Helmet>
                <title>Discover Luxury Living at Empire World  - Zest Property</title>
                <meta name="description" content="Experience the pinnacle of modern living at Empire World, where luxury and convenience come together. Our world-class residential development offers an array of premium amenities, spacious layouts, and stunning views of the surrounding area. As a resident of Empire World, you'll enjoy a lifestyle of comfort and sophistication. Browse our available units and find your perfect home today." />
            </Helmet>
            ...
            <div className='imageofheaderempire'><h1>Empire World</h1></div>
            ...
            <section className='mainmajidi'>
                ...
                <div className='content'>
                    ...
                    <div className='dis'>
                        <h3>Description</h3>
                        <p className='pdis'>
                            Empire World City in Erbil is a luxurious and stunning project series that is located in the heart of Erbil, Iraq. This project series is renowned for its exquisite design, luxurious amenities, and beautiful surroundings. The Empire World City is the epitome of luxury and elegance, offering its residents the highest level of comfort and convenience.


                            <br />
                            <br />
                            <br />
                            The project series comprises of various residential buildings, commercial spaces, and entertainment areas that are all designed to cater to the needs and desires of its residents. The buildings are constructed with the finest materials and are equipped with modern facilities and amenities, ensuring that the residents enjoy the best possible living experience.


                            <br />
                            <br />
                            <br />
                            Moreover, the Empire World City is surrounded by beautifully landscaped gardens, parks, and open spaces that offer a serene and peaceful environment to the residents. The city is also strategically located in the heart of Erbil, providing easy access to all the major attractions and landmarks of the city.


                            <br />
                            <br />
                            <br />
                            Overall, Empire World City is the most luxurious and beautiful place in Erbil, offering a world-class living experience to its residents. It is truly a masterpiece of architecture and design, and an ideal place for those who appreciate the finer things in life.
                        ...
                        <div className='map'>
                            <LoadScript googleMapsApiKey="AIzaSyAoeC-jhvkXaUUCYG8S4KiSzGCxCoiFAO0">
                                <GoogleMap
                                    ...
                                    center={{ lat: 36.1987748, lng: 43.9699775, position: { lat: 36.1987748, lng: 43.9699775 } }}
                                    zoom={18}
                                >
                                    <MarkerF position={{ lat: 36.1987748, lng: 43.9699775 }} />
                                </GoogleMap>
                            </LoadScript>
                        </div>
                    </div>
