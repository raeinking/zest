...
function EmpireAr() {
    ...
    const [projectname, setProjectname] = useState('empire ar')
    ...
    return (
        <>
            <Helmet>
                <title>اكتشف العيش الفخم في إمباير ورلد - عقارات زيست</title>
                <meta name='description' content="تجربة الذروة من العيش الحديث في إمباير ورلد، حيث يلتقي الفخامة والراحة. يوفر مشروعنا السكني العالمي مجموعة من وسائل الراحة الفاخرة وتخطيطات فسيحة وإطلالات ساحرة على المنطقة المحيطة. كساكن في إمباير ورلد، سوف تستمتع بنمط حياة مريح وراقي. استعرض وحداتنا المتاحة وابحث عن بيتك المثالي اليوم." />
            </Helmet>
            <section>
                ...
                <div className='imageofheaderempire'><h1>إمباير وورلد</h1></div>
                ...
                <section className='mainmajidi'>
                    ...
                    <div className='content'>
                        ...
                        <div className='dis'>
                            <h3>وصف</h3>
                            <p className='pdis'>
                                مدينة إمباير ورلد سيتي في أربيل هي سلسلة مشاريع فاخرة ومذهلة تقع في قلب مدينة أربيل في العراق. تشتهر هذه السلسلة بتصميمها الرائع ووسائل الراحة الفاخرة والمناطق الجميلة المحيطة بها. إمباير ورلد سيتي هي التجسيد الحقيقي للفخامة والأناقة، حيث توفر لسكانها أعلى مستوى من الراحة والرفاهية.
                                ...
                                <br />
                                <br />
                                تتكون سلسلة المشاريع من مبانٍ سكنية ومساحات تجارية ومناطق ترفيهية مختلفة مصممة لتلبية احتياجات ورغبات سكانها. تم تشييد المباني باستخدام أفضل المواد وتزويدها بالمرافق ووسائل الراحة الحديثة، مما يضمن للسكان الاستمتاع بأفضل تجربة حياة ممكنة.
                                ...
                                <br />
                                <br />
                                وعلاوة على ذلك، تحيط مدينة إمباير ورلد سيتي بحدائق ومنتزهات ومساحات خضراء جميلة مصممة بشكل جميل توفر بيئة هادئة ومريحة للسكان. كما تقع المدينة بشكل استراتيجي في قلب أربيل، مما يوفر سهولة الوصول إلى جميع المعالم والأماكن الرئيسية في المدينة.
                                <br />
                                <br />
                                <br />

                                بشكل عام، إمباير ورلد سيتي هي أكثر الأماكن الفاخرة والجميلة في أربيل، وتوفر تجربة سكنية عالمية المستوى لسكانها. إنها حقًا تحفة من الهندسة والتصميم، ومكان مثالي لأولئك الذين يقدرون الأشياء الراقية في الحياة.
