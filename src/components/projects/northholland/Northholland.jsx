...
function Northholland() {
    const [brochureDownload, setBrochureDownload] = useState(false)
    const [name, setName] = useState('')
    const [phone, setPhone] = useState('')
    const [email, setEmail] = useState('')
    const [projectname, setProjectname] = useState('Damac Bay 2')
    ...
    return (
        <section>
            <Helmet>
                <title>Experience Tranquil Living in North Holland - zest property</title>
                <meta name='description' content="Discover the beauty of North Holland and experience tranquil living at its finest. Our residential development offers a range of living options to suit your lifestyle, including spacious apartments and elegant villas. Surrounded by stunning natural landscapes and picturesque views, as a resident of North Holland, you'll enjoy a peaceful retreat from the hustle and bustle of everyday life. Explore our available units and make your dream home a reality today." />
            </Helmet>
            ...
            <div className='imageofheadernorth'><h1>North Holland</h1></div>
            ...
            <section className='mainmajidi'>
                ...
                <div className='content'>
                    ...
                    <div className='margin'>
                        ...
                        <div className='overview'>
                            <div className='borderandmargin'>
                                <h5>LOCATION</h5>
                                <h5> Erbil - Mosul Road, opposite of Dream City</h5>
                            </div>
                            <div className='borderandmargin'>
                                <h5>PROJECT TYPE</h5>
                                <h5>Residential</h5>
                    ...
                    <div className='dis'>
                        <h3>Description</h3>
                        <p className='pdis'>
                            North Holland is a prestigious real estate development project located in Erbil - Mosul Road, opposite of Dream City in Iraq. This project consists of a series of residential and commercial buildings that have been constructed quickly and efficiently while maintaining a high level of quality.


                            <br />
                            <br />
                            <br />
                            North Holland is currently one of the most sought-after projects in Erbil, with properties selling at a fast pace. The development offers a range of apartments, offices, and retail spaces, providing residents with a modern and comfortable lifestyle in a convenient location.


                            <br />
                            <br />
                            <br />
                            With its exceptional design and state-of-the-art facilities, North Holland is sure to impress anyone looking for a premium property investment in Erbil. Whether you're an investor or a resident, this project is definitely worth considering for its quality, convenience, and value for money.
