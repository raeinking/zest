...
function Skyland() {
    ...
    const [projectname, setProjectname] = useState('skyland')
    ...
    return (
        <section>
            <Helmet>
                <title>Discover Elevated Living at Sky Land Kirkuk - zest property</title>
                <meta name='description' content="Experience the ultimate in elevated living at Sky Land Kirkuk, where luxury, comfort, and convenience come together. Our residential development offers a range of living options to suit your preferences, including stylish apartments and spacious villas. As a resident of Sky Land Kirkuk, you'll enjoy premium amenities, stunning views, and a vibrant community. Explore our available units and discover your dream home today. " />
            </Helmet>
            ...
            <div className='imageofheaderskyland'><h1>Sky Land Kirkuk</h1></div>
            ...
            <section className='mainmajidi'>
                ...
                <div className='content'>
                    ...
                    <div className='margin'>
                        ...
                        <div className='overview'>
                            <div className='borderandmargin'>
                                <h5>LOCATION</h5>
                                <h5> behind the traffic circle, Al-Hawli Street, Kirkuk 36011</h5>
                            </div>
                            <div className='borderandmargin'>
                                <h5>PROJECT TYPE</h5>
                                <h5>villa</h5>
                    ...
                    <div className='dis'>
                        <h3>Description</h3>
                        <p className='pdis'>
                            Name of Project: Sky Land
                            Location: Kirkuk, behind the traffic circle, Al-Hawli Street, Iraq


                            <br />
                            <br />
                            <br />
                            Sky Land is a residential development situated in Kirkuk, Iraq, conveniently located behind the traffic circle on Al-Hawli Street. The project offers a prime location with easy access to major roads and amenities in the area.


                            <br />
                            <br />
                            <br />
                            One of the notable features of Sky Land is the presence of international schools and a park within the vicinity, providing residents with convenient access to quality education and recreational facilities. This makes it an ideal choice for families, allowing them to spend quality time with their friends and family while enjoying the community's amenities.


                            <br />
                            <br />
                            <br />
                            Sky Land offers a comfortable and convenient living experience, with its strategic location and proximity to essential amenities, making it a desirable choice for residents seeking a modern and family-friendly residential community in Kirkuk.
