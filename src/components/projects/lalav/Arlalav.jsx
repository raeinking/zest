...
function Arlalav() {
    ...
    const [projectname, setProjectname] = useState('lalav ar')
    ...
    return (
        <>
            <Helmet>
                <title>عيش بأناقة في مبنى لالاف گروپ السكني الفخم - عقارات زيست</title>
                <meta name='description' content=" اكتشف الحد الأقصى للحياة الفاخرة في مبنى لالاف گروپ السكني، حيث يتجمع الأناقة والراحة والراحة. تم تصميم مبنانا بما يناسب نمط حياتك، ويوفر وحدات واسعة ومصممة بأناقة مع وسائل الراحة والخدمات الفاخرة. كمقيم في مبنى لالاف گروپ، ستعيش تجربة مثالية للتطور والتميز. استكشف الوحدات المتاحة لدينا واجعل منزل أحلامك حقيقة اليوم." />
            </Helmet>
            <section>
                ...
                <div className='imageofheaderlalav'><h1>لالاف گروپ</h1></div>
                ...
                <section className='mainmajidi'>
                    ...
                    <div className='content'>
                        ...
                        <div className='dis'>
                            <h3>وصف</h3>
                            <p className='pdis'>
                                اسم المجموعة: مجموعة لالاف
                                الموقع: معظم المواقع في أربيل، العراق
                                ...
                                <br />
                                <br />
                                مجموعة لالاف هي مجموعة مبدعة وموثوق بها في أربيل، العراق، حيث تقوم بإنشاء مشاريع سكنية مبهرة تشمل منازل وأبراج عالية الجودة. تشمل بعض المشاريع التي قامت بها المجموعة في أربيل إطلالة على المطار، برجي فينوس، ومنازل السماء والمزيد.
                                ...
                                <br />
                                <br />
                                تعتبر مجموعة لالاف موثوق بها في سوق العقارات في أربيل، حيث تتميز بمبتكرها في تصميم وإنشاء المشاريع السكنية، وتلبية احتياجات العملاء بأعلى مستويات الجودة. تمثل مشاريعها فرصًا استثمارية مجزية ومكانًا مثاليًا للعيش والاستمتاع بالحياة في أربيل.
