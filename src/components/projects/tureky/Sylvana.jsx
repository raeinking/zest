...
const Sylvana = () => {
  ...
  const [projectname, setProjectname] = useState('Sylvana')
  ...
  return (
    ...
    <>
                <Helmet>
                <title>Sylvana Turkey - Exclusive Real Estate Investment with Sylvana</title>
                <meta name='description' content="Explore exclusive real estate investment opportunities in Turkey with Sylvana Skyrus. We offer a diverse range of luxury and premium properties in prime investment locations in Turkey. Begin your journey towards exceptional living in one of the world's most attractive investment destinations." />
            </Helmet>
      <section>
            ...
            <div className='brochurRight'>
              <form style={{ width: '100%', maxWidth: '1000px', maxHeight: '1000px', display: 'flex', flexWrap: 'nowrap' }} onSubmit={handleSubmit}>
                ...
                <div style={{ display: 'flex', marginTop: 10, marginBottom: 10, alignItems: 'center', width: '100%', justifyContent: 'space-between' }}>
                  ...
                  <a href={"//api.whatsapp.com/send?phone=9647502552006&text=hello iam interested in sylvana view can you send me details"}>
        ...
        <div className='imageofheadersylv'><h1>Sylvana</h1></div>
        ...
        <section className='mainmajidi'>
          ...
          <div className='content'>
            ...
            <div className='margin'>
              ...
              <div className='overview'>
                <div className='borderandmargin'>
                  <h5>LOCATION</h5>
                  <h5>Türkiye - Kısım - Bahçeşehir 2</h5>
                </div>
                <div className='borderandmargin'>
                  <h5>PROJECT TYPE</h5>
                  <h5>Residential</h5>
            ...
            <div className='dis'>
              <h3>Description</h3>
              <p className='pdis'>
              Introducing "Sylvana Residences" in Istanbul's Saydiah district, near the Al-Jadrieah Bridge. This upscale development comprises seven buildings, with Type A boasting 14 floors and Type B soaring to 20.</p><p>The first 4 floors host a premium shopping area, while 4 floors below ground offer secure parking. These luxurious units redefine modern living with high-end finishes and abundant natural light.</p>
<br />
<br />
<p>Enjoy the rooftop pool, landscaped gardens, and a fitness center. "Sylvana Residences" is the epitome of sophisticated urban living, combining convenience and elegance effortlessly.</p>
<br />
<br />
              <div>
              ...
              <div className='map'>
                <LoadScript googleMapsApiKey="AIzaSyAoeC-jhvkXaUUCYG8S4KiSzGCxCoiFAO0">
                  <GoogleMap
                    ...
                    center={{ lat: 41.097086, lng: 28.648283, position: { lat: 41.097086, lng: 28.648283 } }}
                    zoom={18}
                >
                    <MarkerF position={{ lat: 41.097086, lng: 28.648283 }} />
  </GoogleMap>
                </LoadScript>
              </div>
            </div>
