...
function Sylvanaar() {
    ...
    const [projectname, setProjectname] = useState('Sylvana arabic')
    ...
    return (
        <>
            <Helmet>
                <title>سيلفانا تركيا - الاستثمار العقاري المميز في تركيا مع سيلفانا</title>
                <meta name='description' content="ستكشف فرص العقارات الاستثمارية المتميزة في تركيا مع سيلفانا سكايروس. نقدم مجموعة متنوعة من العقارات الفاخرة والمميزة في أماكن استثمارية مثالية في تركيا. ابدأ رحلتك نحو العيش المتميز في واحدة من أجمل وجهات الاستثمار في العالم" />
            </Helmet>
            <section>
                        ...
                        <div className='brochurRight arfrom'>
                            <form className='arfrom' style={{ width: '100%', maxWidth: '1000px', maxHeight: '1000px', display: 'flex', flexWrap: 'nowrap' }} onSubmit={handleSubmit}>
                                ...
                                <div style={{ display: 'flex', marginTop: 10, marginBottom: 10, alignItems: 'center', width: '100%', justifyContent: 'space-between' }}>
                                    ...
                                    <a href={"//api.whatsapp.com/send?phone=9647502552006&text=مرحباً ، أنا مهتم بإطلالة Sylvana ، هل يمكنك أن ترسل لي التفاصيل؟"}>
                ...
                <div className='imageofheadersylv'><h1>سيلفانا تركيا</h1></div>
                ...
                <section className='mainmajidi'>
                    ...
                    <div className='content'>
                        ...
                        <div className='dis'>
                            <h3>وصف</h3>
                            <p className='pdis'>
                            نقدم لكم "مساكن سيلفانا" في منطقة السيدية في اسطنبول بالقرب من جسر الجادرية. يتكون هذا التطوير الراقي من سبعة مباني، حيث يضم النوع A 14 طابقًا والنوع B يرتفع إلى 20.</p><p>تحتوي الطوابق الأربعة الأولى على منطقة تسوق متميزة، بينما توفر الطوابق الأربعة تحت الأرض مواقف آمنة للسيارات. تعيد هذه الوحدات الفاخرة تعريف الحياة العصرية بتشطيبات راقية وإضاءة طبيعية وفيرة.</p>
<br />
<br />
<p>استمتع بحمام السباحة على السطح والحدائق ذات المناظر الطبيعية ومركز اللياقة البدنية. "Sylvana Residences" هو مثال للحياة الحضرية المتطورة، حيث يجمع بين الراحة والأناقة دون عناء.</p>
                            <div>
